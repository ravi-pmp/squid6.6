...
/* The install prefix */
#define DEFAULT_PREFIX /opt/squid
...
#define LT_DLSEARCH_PATH "/lib:/usr/lib:/usr/lib64/iscsi"
...
#define PACKAGE_STRING "Squid Web Proxy 6.6"
...
#define SQUID_CONFIGURE_OPTIONS " '--prefix=/opt/squid' '--sysconfdir=/opt/squid/etc' '--localstatedir=/var' 'PKG_CONFIG_PATH=:/usr/lib64/pkgconfig:/usr/share/pkgconfig'"
